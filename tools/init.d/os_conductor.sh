...
# Default-Stop:      0 1 6
# Short-Description: OS_Conductor server
# Description:       Backend OS_Conductor server
### END INIT INFO
...
DESC="OpenStack Conductor Service"
PROJECT_NAME=os_conductor
NAME=${PROJECT_NAME}
#!/bin/sh
