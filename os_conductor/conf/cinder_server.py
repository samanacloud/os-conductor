...
def register_opts(conf):
    conf.register_group(cinder_server_group)
    conf.register_opts(cinder_server_options, group=cinder_server_group)

def list_opts():
    return {cinder_server_group: cinder_server_options}
